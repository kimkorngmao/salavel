...
<section class="bg-white">
    <div class="flex items-center px-6 py-12 mx-auto">
        <div>
            ...
            <h1 class="mt-3 text-2xl font-semibold text-gray-800 md:text-3xl">We are sorry...!</h1>
            <p class="mt-4 text-gray-500">You don't have permission to access this page</p>
